...
export JEECG_ENGINE_DIRECT_ENABLED="${JEECG_ENGINE_DIRECT_ENABLED:-true}"
export JEECG_ENGINE_PATH="${JEECG_ENGINE_PATH:-/internal/codegen/engine/render}"
export JEECG_LEGACY_ONLINE_FALLBACK_ENABLED="${JEECG_LEGACY_ONLINE_FALLBACK_ENABLED:-true}"
export JEECG_CODEGEN_PATH="${JEECG_CODEGEN_PATH:-/internal/codegen/render}"
...
export JEECG_INTERNAL_APP_ID="${JEECG_INTERNAL_APP_ID:-smart_code_ark}"
export JEECG_INTERNAL_SIGN_SECRET="${JEECG_INTERNAL_SIGN_SECRET:-}"
export JEECG_INTERNAL_SIGN_VERSION="${JEECG_INTERNAL_SIGN_VERSION:-v1}"
