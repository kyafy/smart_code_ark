...
Use importer script to consolidate Jeecg online templates into this local repo:
...
- `template-repo/docs/jeecg-template-importer.md`
- `template-repo/docs/jeecg-placeholder-mapping-v1.md`
- `template-repo/scripts/jeecg-import-map.json`
